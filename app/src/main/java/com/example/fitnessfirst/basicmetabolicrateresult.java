...
public class basicmetabolicrateresult extends AppCompatActivity {
    TextView txt;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_basicmetabolicrateresult);

        txt=(TextView) findViewById(R.id.textView_basicmetabolicrateresult);
