...
public class dailyCalorieCounter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_calorie_counter);
...
getSupportActionBar().hide();
        ...
        calculate=(Button) findViewById(R.id.calculatedailycalorieintake);
            ...
            private void findradiobutton(int checked) {
                                             switch (checked){
                                                 case R.id.radiobutton_male:
                                                    ...
                                                    float shift= calculatemale(String.valueOf(weight), String.valueOf(height),q)*a;
                                                    // calc.calculate(e,w,q);
                                                     int send=(int) shift;
                                                     String move=String.valueOf(send);
                                                    // Log.d("calcs", "findradiobutton: "+shift);
                                                     Intent intent=new Intent(dailyCalorieCounter.this, dailycaloriecounterresult.class);
                                                 ...
                                                 case R.id.radiobutton_female:
                                                     ...
                                                     //e=ed3.getText().toString();
                                                      shift=calculatefemale(String.valueOf(weight), String.valueOf(height),q)*a;
                                                     // calc.calculate(e,w,q);
                                                    // Log.d("calcs", "findradiobutton: "+shift);
                                                      send=(int) shift;
                                                      move=String.valueOf(send);
                                                      intent=new Intent(dailyCalorieCounter.this, dailycaloriecounterresult.class);
                                                     intent.putExtra("key",move);
                                                     startActivity(intent);
        ...
        sp3=(Spinner) findViewById(R.id.spinner_activity);
        String[] activity_levels=getResources().getStringArray(R.array.activity_levels);
        ArrayAdapter adapter3=new ArrayAdapter(this,android.R.layout.simple_spinner_item,activity_levels);
        ...
        sp3.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (parent.getItemAtPosition(position).equals("Little or No Exercise"))
                {
                    a= (float) 1.2;
                   // Log.d("abc", "onItemSelected: "+a);
                }
                if (parent.getItemAtPosition(position).equals("Light:Exercise 1-3 times/week"))
                {
                    a= (float) 1.375;
                    // Log.d("abc", "onItemSelected: "+a);
                }
                if (parent.getItemAtPosition(position).equals("Moderate:Exercise 4-5 times/week"))
                {
                    a= (float) 1.55;
                    // Log.d("abc", "onItemSelected: "+a);
                }
                if (parent.getItemAtPosition(position).equals("Active:Intense exercise 3-4 times/week"))
                {
                    a= (float) 1.65;
                    // Log.d("abc", "onItemSelected: "+a);
                }
                if (parent.getItemAtPosition(position).equals("Very Active:Intense exercise 6-7 times/week"))
                {
                    a= (float) 1.725;
                    // Log.d("abc", "onItemSelected: "+a);
                }
                if (parent.getItemAtPosition(position).equals("Extra Active:Intense exercise daily or Physical job"))
                {
                    a= (float) 1.925;
                    // Log.d("abc", "onItemSelected: "+a);
                }
